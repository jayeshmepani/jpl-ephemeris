...
- [x] Verification-mode ledger: `docs/VALUE_VERIFICATION_MATRIX.md` now classifies all `204` public functions by current validation mode so "called in tests" is no longer conflated with "externally numerically certified."
