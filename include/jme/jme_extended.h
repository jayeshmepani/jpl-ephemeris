...
typedef enum jme_extended_constant {
    ...
    JME_BODY_VARUNA = 271,
    JME_BODY_VESTA = 272,
    JME_CALC_APPARENT_POSITION = 273,
    JME_CALC_ASTROMETRIC = 274,
    JME_CALC_CENTER_BODY = 275,
    JME_CALC_DISTANCE_AU = 276,
    JME_CALC_DISTANCE_KM = 277,
    JME_CALC_HIGH_PRECISION = 278,
    JME_CALC_ICRS = 279,
    JME_CALC_NO_ABERRATION = 280,
    JME_CALC_NO_LIGHT_DEFLECTION = 281,
    JME_CALC_RAW_VECTOR = 282,
    JME_CALC_RECTANGULAR = 283,
    JME_CALC_SPHERICAL = 284,
    JME_CALC_STRICT = 285,
    JME_CALC_TOPOCENTRIC = 286,
    JME_CALC_VELOCITY_PER_DAY = 287,
    JME_CALC_VELOCITY_PER_SECOND = 288,
